# 5. Focus on Student Mental Wellbeing and Inclusive Culture
...
Academic environments are notoriously stressful, and platforms built for sharing academic resources can sometimes inadvertently contribute to imposter syndrome, toxic competitiveness, or anxiety. Resource-Adda is designed to be the central hub for students, which puts it in a unique position to influence student culture.
...
4. **Onboarding & Guidelines:** Ensure new users are introduced to the platform's culture of mutual support. Community guidelines must strictly enforce a zero-tolerance policy for bullying, elitism, or toxic behavior.
5. **Resources for Wellbeing:** Provide dedicated sections or quick links to institutional counselors, mental health resources, and peer support groups.
