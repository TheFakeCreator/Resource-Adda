...
1. **Architecture Decision Records (ADRs)**
   - Path: `docs/adr/*.md`
   - Read these to understand *why* certain technical and cultural decisions were made (e.g., dynamic markdown pages, Cloudinary storage, universal deployability, student wellbeing).
