  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.isExternalLink) {
        if (!formData.externalLink) throw new Error('Please provide an external link');
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        <Card className="border-green-500 bg-green-50 dark:bg-green-900/10">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl text-green-700 dark:text-green-400">Upload Successful!</CardTitle>
            <CardDescription className="text-lg">
              Your resource has been submitted and is currently <strong>Pending Admin Approval</strong>. 
              Once an admin verifies it, it will be available in the public library.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6 pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.type} onValueChange={(val: string | null) => val && setFormData({ ...formData, type: val })}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.branch} onValueChange={(val: string | null) => val && setFormData({ ...formData, branch: val })}>
                  <SelectTrigger className="w-full">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.semester} onValueChange={(val: string | null) => val && setFormData({ ...formData, semester: val })}>
                  <SelectTrigger className="w-full">
            ...
            <div className="border-t pt-6 mt-6">
              <div className="flex gap-4 mb-6">
                <Button
                  ...
                  className="flex-1"
                  onClick={() => setFormData({ ...formData, isExternalLink: false })}
                >
                ...
                <Button
                  ...
                  variant={formData.isExternalLink ? "default" : "outline"}
                  className="flex-1"
                  onClick={() => setFormData({ ...formData, isExternalLink: true })}
                >
              ...
              {formData.isExternalLink ? (
                <div className="space-y-2 p-4 bg-muted/50 rounded-xl border border-border">
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">Provide a link to Google Drive, Dropbox, or any other public resource.</p>
                </div>
              ) : (
                <div className="space-y-2 p-4 bg-muted/50 rounded-xl border border-border">
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">Max file size: 10MB. Allowed types: PDF, PNG, JPG.</p>
                </div>
              )}
            </div>
