...
const RESOURCE_TYPE_COLORS: Record<
  string,
  {
    badge: string;
    dot: string;
...
const DUMMY_DOC: Document = {
  ...
  description:
    "These are my complete handwritten notes for Engg Math 1. It covers Matrices, Calculus, and Vector Spaces.",
  subject: "Mathematics",
  semester: 1,
  ...
  adminPicks: [
    {
      ...DUMMY_DOC,
      _id: "f1",
      title: "Data Structures & Algorithms - Expert Guide",
    },
  ],
  topRated: [
    {
      ...DUMMY_DOC,
      _id: "t1",
      title: "Physics Lab Manual - Fully Solved",
      averageRating: 5.0,
      type: "Lab Manual",
    },
    {
      ...DUMMY_DOC,
      _id: "t2",
      title: "Database Systems PYQs 2020-2023",
      averageRating: 4.9,
      type: "PYQ",
    },
  ],
...
export default function FeaturedPage() {
  ...
  const renderResourceCard = (doc: Document) => {
    ...
    return (
      <Link
        ...
        key={doc._id}
        className="block group w-full min-w-[300px] md:min-w-[350px] max-w-[400px] snap-center"
      >
        <Card
  ...
  return (
    <div className="min-h-screen bg-background pb-12 flex flex-col">
      ...
      {heroState !== "hidden" && (
        <section
          className={`relative overflow-hidden bg-gradient-to-br from-rose-500/10 via-orange-500/10 to-amber-500/5 transition-all duration-1000 ease-in-out origin-top border-border ${
        ...
        >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl relative z-10 animate-breath">
            <Badge
              variant="outline"
              className="mb-6 border-rose-500/30 text-rose-500 bg-rose-500/10 px-4 py-1.5 rounded-full font-medium shadow-sm"
            >
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-8 max-w-2xl mx-auto">
              Studying can be overwhelming. We've curated the absolute best
              resources to make your learning journey easier, warmer, and
      ...
      {/* Sections Container */}
      <div
        className={`container mx-auto px-4 sm:px-6 lg:px-8 space-y-16 flex-1 transition-all duration-1000 ${
          heroState === "hidden"
            ? "opacity-100 mt-8 translate-y-0"
            : "opacity-0 h-0 overflow-hidden mt-0 translate-y-12"
        }`}
      >
        {loading ? (
                ...
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Highest quality resources manually verified by our team.
                    </p>
                  </div>
                </div>
              ...
              <section>
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      The most loved resources voted by the community.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6 overflow-x-auto pb-6 snap-x snap-mandatory scrollbar-hide py-2 px-1">
              ...
              trending.length === 0 && (
                <div className="py-20 text-center bg-card rounded-2xl border border-border border-dashed">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Check back later when resources get trending or rated.
                  </p>
                  <Link href="/explore">
