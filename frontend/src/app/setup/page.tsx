        ...
        <CardContent className="pt-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="instituteName" className="text-foreground">
                Institute Name
              </Label>
              <Input
                id="instituteName"
            ...
            <div className="space-y-2">
              <Label htmlFor="allowedEmailPatterns" className="text-foreground">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Students registering with these domains will be automatically
                verified.
              </p>
            </div>
