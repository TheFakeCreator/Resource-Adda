...
description: "API documentation, OpenAPI specs, developer guides for Resource-Adda. Use when documenting APIs, creating developer guides, generating API specs, or maintaining documentation."
---
...
Document Resource-Adda endpoints following `docs/guides/API_STANDARDS.md`:
