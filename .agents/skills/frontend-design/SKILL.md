...
> Multiple sub-skills can be combined for a single task (e.g. `shadcn` + `frontend-patterns` for building Resource-Adda UI).

---

## Core — Resource-Adda Patterns

Project-specific frontend conventions and framework best practices.

| Sub-Skill                | Read                                          | Use When                                                                                                     |
| ------------------------ | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| **Frontend Patterns**    | `./core/frontend-patterns/SKILL.md`           | Building React components with Resource-Adda conventions, App Router, Tailwind CSS v4, react-hook-form + Zod |
