...
1. **Prompt** _(required)_: "What image do you want to generate? Describe the scene, subject, style, and any important details."
2. **Aspect ratio** _(optional, default `16:9`)_: "What aspect ratio? Options: `1:1`, `3:4`, `4:3`, `9:16`, `16:9` (default), `9:21`, `21:9`"
3. **Model** _(optional, default `photon-1`)_: "Use `photon-1` (higher quality) or `photon-flash-1` (faster and cheaper)?"
4. **Reference image** _(optional)_: "Do you have a reference image URL for style or structure guidance?"
...
|------|---------|-------------|
| `--prompt` | _(required)_ | Text description of the image |
