...
exports.GamificationService = exports.BADGE_THRESHOLDS = exports.XP_REWARDS = void 0;
...
class GamificationService {
    ...
    static async awardPoints(userId, type) {
        ...
        const earnedBadges = exports.BADGE_THRESHOLDS.filter((badge) => user.contributionPoints >= badge.points &&
            !user.badges.includes(badge.name)).map((badge) => badge.name);
