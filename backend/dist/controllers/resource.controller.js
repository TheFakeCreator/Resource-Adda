...
exports.getFeaturedDocuments =
  exports.voteReview =
  exports.addReview =
  exports.getReviews =
  exports.incrementDownload =
  exports.getDocumentById =
  exports.getApprovedDocuments =
  exports.reviewContribution =
  exports.getPendingContributions =
...
const uploadResource = async (req, res) => {
  try {
    ...
    if (isExternalLink === "true" || isExternalLink === true) {
      ...
      fileUrl = await (0, upload_1.uploadToCloudinary)(
        req.file.buffer,
...
const getPendingContributions = async (req, res) => {
  try {
    const contributions = await Contribution_1.default
...
const getApprovedDocuments = async (req, res) => {
  try {
    ...
    const documents = await Document_1.default
      .find(filter)
...
const getDocumentById = async (req, res) => {
  try {
    const document = await Document_1.default
...
const incrementDownload = async (req, res) => {
  try {
    const document = await Document_1.default.findByIdAndUpdate(
      req.params.id,
      { $inc: { downloadCount: 1 } },
      { new: true },
    );
...
const getFeaturedDocuments = async (req, res) => {
  try {
    ...
    const [adminPicks, topRated, trending] = await Promise.all([
      Document_1.default
        .find({ ...baseFilter, isFeatured: true })
