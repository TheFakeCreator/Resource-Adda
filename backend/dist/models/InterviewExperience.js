...
const InterviewExperienceSchema = new mongoose_1.Schema({
    ...
    status: { type: String, enum: Object.values(Contribution_1.ContributionStatus), default: Contribution_1.ContributionStatus.PENDING },
    tags: [{ type: String }],
...
exports.default = mongoose_1.default.model('InterviewExperience', InterviewExperienceSchema);
