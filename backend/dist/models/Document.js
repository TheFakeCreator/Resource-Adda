...
const DocumentSchema = new mongoose_1.Schema({
    ...
    semester: { type: Number, required: true, enum: constants_1.SEMESTERS },
    branch: { type: String, required: true, enum: constants_1.INSTITUTE_BRANCHES },
    type: { type: String, required: true, enum: constants_1.RESOURCE_TYPES },
